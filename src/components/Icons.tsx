// Shared SVG icon components to avoid duplication across the codebase
...
export function CheckCircleIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function LocationIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function EmailIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function PhoneIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function ClockIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function GearIcon({ className = "w-5 h-5", strokeWidth = 1.5 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function ShieldIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function BoltIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function BeakerIcon({ className = "w-5 h-5", strokeWidth = 1.5 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function MenuIcon({ className = "w-6 h-6", isOpen = false }: IconProps & { isOpen?: boolean }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        strokeLinecap="round"
...
export function WeChatIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function ArrowLeftIcon({ className = "w-5 h-5", strokeWidth = 2 }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
